...
router.get('/transaction/:transactionId', validateSystemKey, paymentController.getPaymentByTransactionId);
router.post('/webhook', paymentController.webhookHandler);
router.post('/notifications', paymentController.notificationHandler);
